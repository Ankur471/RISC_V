...
HD_PWD='D:/trainingvlsi/project_risc_v/project_risc_v.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Single_Cycle_Core.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Single_Cycle_Core.tcl -notrace
